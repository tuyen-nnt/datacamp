...
You can use the slides to remember the method to use to get the data.
Similarly, you can use the slides to remember the proper method for parsing the JSON in the requests' response.
After parsing the object as a JSON, the "score" key will get you a posts' score.*/
